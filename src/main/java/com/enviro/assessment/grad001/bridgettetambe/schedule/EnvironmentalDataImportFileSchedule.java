...
import java.util.List;
    ...
    public class EnvironmentalDataImportFileSchedule {
        private static final Logger log = LoggerFactory.getLogger(com.enviro.assessment.grad001.bridgettetambe.schedule.EnvironmentalDataImportFileSchedule.class);
